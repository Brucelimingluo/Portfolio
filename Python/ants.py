...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        while position != beehive:
            if rANTdom_else_none(position.bees) != None and self.min_range <= distance and distance <= self.max_range:
                return rANTdom_else_none(position.bees)
